...
void	player_init(t_map *game)
{
	...
	game->play->position_x = game->play->position_x_map * SCALE + SCALE / 2;
	game->play->position_y = game->play->position_y_map * SCALE + SCALE / 2;
	game->play->pos_x_m_map = game->play->position_x_map * SCALE2 + SCALE2 / 2;
	game->play->pos_y_m_map = game->play->position_y_map * SCALE2 + SCALE2 / 2;
}
